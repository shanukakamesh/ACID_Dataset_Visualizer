...
from PyQt6.QtWidgets import QApplication, QMainWindow, QFileDialog, QGraphicsScene, QGraphicsPixmapItem, QGraphicsTextItem, QSlider, QMessageBox, QProgressBar
from PyQt6.QtGui import QPixmap, QStandardItemModel, QStandardItem, QPen, QColor, QFont, QPainterPath
from PyQt6.QtCore import Qt, QPointF
import json
import xml.etree.ElementTree as ET
from utils.browse_images_and_annotations import *
from utils.set_variables import *
from utils.set_window_parameters import *
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        set_variable(self)
        init_window_parameters(self)

        # Connect the button clicked signal to a slot
        self.ui.btnImagePath.clicked.connect(lambda:browse_image_folder(self))  #Adding images
        self.ui.btnAnnotationPath.clicked.connect(lambda:browse_annotation_file(self))  #Adding captioning annotations
        self.ui.btnAnnotationPathDetetctionSegmentation.clicked.connect(lambda:browse_annotation_detection_segmentation(self))  #Adding object detection and instance segmentation annotations 
